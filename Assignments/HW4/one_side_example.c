...
int main(int argc, char **argv)
{
    ...
    if (rank == 0)
    {
        ...
        MPI_Alloc_mem((long)(size * sizeof(int)), MPI_INFO_NULL, (void *)&schedule);
        ...
        MPI_Win_create(schedule, (long)(size * sizeof(int)), sizeof(int), MPI_INFO_NULL,
                       MPI_COMM_WORLD, &win);
